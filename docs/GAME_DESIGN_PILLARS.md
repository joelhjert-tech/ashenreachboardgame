...
- Dangerous sectors: traversal should feel risky, with each region escalating
...
- Escalating threat: the board should become harsher over time through threat
  cards, scars, and session-wide escalation.
