export const APPROVED_LEGACY_HEAT_CONTENT_IDS = new Set([
  ...
  "escalation-ashfall-curfew", "escalation-blackstar-hunger", "escalation-choir-feedback", "escalation-crownfall-writ", "escalation-marrow-surgery-debt", "escalation-ridge-suture", "escalation-saltwind-lockdown", "escalation-webglass-afterimage",
  ...
  "signal-rotted-engineer", "signal-witch", "siren-relay-echo", "soot-stained-cutpurse", "spindle-static-squall", "starless-taxation", "static-censer-acolyte", "suture-storm", "toll-scrip-urchins", "void-marshal", "void-salt-sickness", "warden-span-vigil", "webglass-echo-trap", "webglass-snarefield", "yard-rivet-brute"
]);
