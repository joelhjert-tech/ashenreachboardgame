...
`glass-chime-swarm` and `spindle-static-squall` are already in the duplicate group. These cards keep generic legacy Heat effects and require their existing individual retirement decisions; the rebuild must not override that program.
