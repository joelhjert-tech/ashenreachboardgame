...
describe("Ashen Reach UI validation stress states", () => {
  ...
  it("keeps host battle identity headers outside portrait art and limits combat log density", () => {
    ...
    expect(within(battleRolls).getByTestId("three-battle-dice")).toBeInTheDocument();
