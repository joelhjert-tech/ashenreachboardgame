  ...
  blue: [
    {
      ...
      gameplayRole: "Scar pressure event.",
      linkedMechanic: "Signal check against existing Scar count.",
      text: "Each character with 3 or more Scars must test Signal 9. Fail: take 1 wound.",
    ...
    },
    {
      ...
      text: "Test Signal 8. Pass: soothe 1 Scar effect this turn. Fail: this card remains on the space.",
    ...
    },
    {
      ...
      gameplayRole: "Scar-control reward.",
      linkedMechanic: "Minor cleanse support.",
      text: "Take this asset. Once per turn, you may ignore one inactive Scar trigger.",
